...
public:
  ...
  typedef IntrusiveUnorderedMap<FederationHandle, Federation> FederationHandleFederationMap;
  ...
  typedef IntrusiveUnorderedMap<std::string, Federation> FederationNameFederationMap;
