...
void
SynchronizationFederate::setFederateHandle(FederateHandle const& federateHandle)
{
  IntrusiveUnorderedMap<FederateHandle, SynchronizationFederate>::Hook::setKey(federateHandle);
}
